user_registered_mail = {
    "de": {
        ...
        "new_user_text": "Glückwunsch, ein neuer Benutzer hat sich gerade auf deiner LocalCrag Instanz angemeldet",
        "LOCALCRAG": "LocalCrag",
    ...
    "en": {
        "title": "New user!",
        "new_user_text": "Congratulations, a new user has just registered on your LocalCrag instance",
        "LOCALCRAG": "LocalCrag",
